...
namespace BagarBasse.DataAccess.Migrations
{
    ...
    [Migration("20230323145402_ChangedOrderUserType")]
    partial class ChangedOrderUserType
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BagarBasse.Shared.Models.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BagarBasse.Shared.Models.Address", b =>
                {
                    b.HasOne("BagarBasse.Shared.Models.User", null)
                        .WithOne("Address")
                        .HasForeignKey("BagarBasse.Shared.Models.Address", "UserId")
